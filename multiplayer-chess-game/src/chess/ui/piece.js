...
const Piece = (props) => {
    ...
    const boardInteractive = props.boardInteractive != undefined ? props.boardInteractive : true
    ...
    return <Image image={image}
         x = {props.x - 90}
         y = {props.y - 90}
         draggable = {canThisPieceEvenBeMovedByThisPlayer && isItThatPlayersTurn && boardInteractive}
